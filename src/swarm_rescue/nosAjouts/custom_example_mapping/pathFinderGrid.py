...
class PathFinderGrid(Grid):
    ...
    def update(self, map_possible_positions, start_world = (-50.0, 0), goal_world = (-472, 174), **kwargs):
        ...
        graph = tcod.path.SimpleGraph(cost=map_possible_positions, cardinal=1, diagonal=1)
